...
export AWS_ACCOUNTID=220286576909
export AWS_REGION=us-east-2
export SUBNET1=subnet-91fe25f8
export SUBNET2=subnet-657b921e
export SUBNET3=subnet-276f606d
export SECURITYGROUPID=sg-3cf47e57
export KEY_NAME=aokad-awsbatch-ohaio
export S3_BUCKET=awsbatch-aokad-ohaio
export AMI_ID=ami-64300001
